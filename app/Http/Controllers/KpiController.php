...
FROM
    ...
    , TB_M20_HEAT_COMM@VINA_MESUSER B
WHERE 1=1
AND A.HEAT_NO = B.HEAT_NO
AND B.PSV_DT LIKE :P_YEAR||'%'
AND SUBSTR(A.RAW_MTL_PRD_CD,1,2) = 'AA'
GROUP BY    
    SUBSTR(B.PSV_DT,0,6)
ORDER BY 1
						";
...
//		$year = '2016';
	...
	/* TONG SO LUONG TINH THEO DIMENSION */
	public function smp_mtl_rsl_04($year){
		$sql =
			"
				WITH HEAT_WGT AS (
				SELECT
